//altsyncram ADDRESS_ACLR_A="CLEAR0" CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" INIT_FILE="UNUSED" INTENDED_DEVICE_FAMILY=""Cyclone IV E"" NUMWORDS_A=256 OPERATION_MODE="ROM" OUTDATA_ACLR_A="CLEAR0" OUTDATA_REG_A="CLOCK0" WIDTH_A=0 WIDTH_B=1 WIDTH_BYTEENA_A=1 WIDTH_BYTEENA_B=1 WIDTH_ECCSTATUS=3 WIDTHAD_A=8 WIDTHAD_B=1 aclr0 address_a clock0 q_a
...
module  mgmj31
	...
	defparam
		mgl_prim1.address_aclr_a = "CLEAR0",
		...
		mgl_prim1.outdata_aclr_a = "CLEAR0",
